...
public class LecteurDeFichierRamassageHO3 {

    public static InstanceRamassage lireInstanceDepuisFichierHO3(String nomFichier) throws IOException {
        ...
        double longueurRue = graphe.obtenirLongueurArete(idU, idV);
        ...
        boolean estSimple = graphe.estAreteDoubleSensUneVoie(idU, idV);

        EncombrantSurRue encombrant =
                new EncombrantSurRue(idU, idV, positionDepuisU, longueurRue, estSimple);
