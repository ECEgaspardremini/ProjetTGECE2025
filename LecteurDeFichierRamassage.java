...
public class LecteurDeFichierRamassage {

    public static InstanceRamassage lireInstanceDepuisFichier(String nomFichier) throws IOException {
        ...
        try (BufferedReader br = new BufferedReader(new FileReader(nomFichier))) {
            ...
            while ((ligne = br.readLine()) != null) {
                ...
                if (morceaux[0].equalsIgnoreCase("NODES")) {
                    ...
                    int nbAretes = Integer.parseInt(morceaux[1]);
                    int compteur = 0;
                    while (compteur < nbAretes) {
        ...
        if (idU == null || idV == null) {
            throw new IllegalArgumentException("Sommet de l'encombrant inconnu : " + nomEncomU + " ou " + nomEncomV);
        }
